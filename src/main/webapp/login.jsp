...
<div class="login-page">
    ...
    <aside class="brand-panel">
        <div class="brand-panel__content">
            ...
            <h1 class="brand-name">Sunrise<span>Dental</span></h1>
            <p class="brand-tagline">Appointment &amp; Patient Management System</p>
            ...
            <ul class="brand-points">
                ...
                <li>
                    <span class="tick">&#10003;</span>
                    Patient records found in seconds
                </li>
                <li>
                    <span class="tick">&#10003;</span>
                    Accurate bills printed on the spot
                </li>
            </ul>

            <p class="brand-footer">Colombo &middot; Established 2015</p>
        </div>
    </aside>
